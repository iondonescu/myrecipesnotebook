...
plus1.onclick = function adaugaMaterie() {
    ...
    cell2.innerHTML = "<select id=\"um\" name=\"um[]\">\n" +
        ...
        "                                <option value=\"ceașcă\">ceașcă</option>\n" +
        "                                <option value=\"buc\">buc</option>\n" +
        "                            </select>";
    cell3.innerHTML = " <input style=\"max-width: 70px\" type=\"text\" name=\"cantitate[]\"  required/>";
...
plus2.onclick = function adaugaFotografie() {
    ...
    if (nrFotografii < 5) {
        ...
        cell2.innerHTML = "<div class=\"minus\">\n" +
            "                           <i class=\"fas fa-minus-circle sterge\" style=\"margin-left: 30px\" onclick=\"stergeFotografie(this)\"></i>\n" +
            "                       </div>";
        nrFotografii++;
        if(nrFotografii == 5){plusFoto.classList.add("hidden")};
         }
    else {
            plusFoto.classList.add("hidden");
        }

}

/*
sterge fotografie adăugată
 */
